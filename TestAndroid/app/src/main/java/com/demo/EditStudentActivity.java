...
public class EditStudentActivity extends AppCompatActivity {
    ...
    public void btnSave_onClick(View v) {
        ...
        if(databaseHelper.update(student)){
    ...
    private void loadData(){
        ...
        editTextDiem.setText(String.valueOf(student.getDiem()));
        editTextMaSV.setText(student.getMaSV());
        editTextTenSV.setText(student.getTenSV());
        ...
        spinnerGender.setSelection(genders.indexOf(student.getGioitinh()));
        ...
        spinnerFalcuty.setSelection(falcuties.indexOf(student.getChuyennganh()));
    }
}
